    ...
    <section className="h-full">
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl-pb-24">
          {/* text */}
          <div className="text-center xl:text-left order-2 xl:order-none space-y-10">
            <span>Software Developer</span>
            <h1 className="text-[48px] xl:text[80px] leading-[1.7] font-semibold mb-6">
              Hello I'm <br /> <span className="text-accent">Dariush Kadkhoda</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80 leading-[2] text-2xl">
